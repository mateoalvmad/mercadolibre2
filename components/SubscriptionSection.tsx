  ...
  return (
    <section className='w-full'>
      <div className="flex justify-center pt-14">
        <div className="flex justify-between w-[500px] md:w-[1180px] h-[87px] rounded-t-md bg-gradient-to-r from-[#a90f90] to-[#0c1a51]">
      ...
      <div className="flex justify-center">
        <div className="flex flex-col w-[500px] md:w-[1180px] h[276px] rounded-t-md bg-white">
          ...
          <div className="flex flex-col md:flex-row gap-5 md:gap-[169px] pt-[10px] pr-6 pb-[54px] pl-6">
