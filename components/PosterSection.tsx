  ...
  payments: [
   {
    children:
      <svg width="48" height="49" viewBox="0 0 48 49" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M28.5 27.5H14.5C14.2239 27.5 14 27.7239 14 28C14 28.2761 14.2239 28.5 14.5 28.5H28.5C28.7761 28.5 29 28.2761 29 28C29 27.7239 28.7761 27.5 28.5 27.5Z" fill="#0864EE"/>                                </g>
        <defs>
          <clipPath id="clip0_1_53">
            <rect width="48" height="48" fill="white" transform="translate(0 0.5)"/>            </clipPath>
        </defs>
      </svg>,
