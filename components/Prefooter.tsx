const Prefooter = () => {
  return (
    <div className='flex justify-center gap-10 bg-white pb-16 pl-40 pr-40 pt-16'>
      <div className='flex flex-col md:w-[1180px] md:flex-row'>
        <div className='contenido-prefooter'>
          ...
          <span className='titulo-prefooter'>
            Paga con tarjeta o en efectivo
          </span>
          <span className='w-[303px] pt-0.5'>
        ...
        <div className='invisible self-center md:visible'>
          <svg
            width='1'
            height='66'
            viewBox='0 0 1 66'
        ...
        <div className='contenido-prefooter'>
          ...
          >
            <path
              d='M22.3787 33.8789L16.7929 28.2931C16.4024 27.9026 16.4024 27.2694 16.7929 26.8789L18.3787 25.2931C18.7692 24.9026 19.4024 24.9026 19.7929 25.2931L23.0858 28.586L32.3787 19.2931C32.7692 18.9026 33.4024 18.9026 33.7929 19.2931L35.3787 20.8789C35.7692 21.2694 35.7692 21.9026 35.3787 22.2931L23.7929 33.8789C23.4024 34.2695 22.7692 34.2695 22.3787 33.8789Z'
              fill='#3483FA'
            />
            <path
              fill-rule='evenodd'
              clip-rule='evenodd'
              d='M25.2087 1.4126C25.2087 1.4126 18.2087 11.4126 1.20867 8.4126C1.20867 8.4126 -4.79133 37.7676 25.2087 53.5906C55.2087 37.7676 49.2087 8.4126 49.2087 8.4126C32.2087 11.4126 25.2087 1.4126 25.2087 1.4126Z'
              stroke='#474747'
              stroke-width='1.413'
